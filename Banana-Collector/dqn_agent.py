...
# Log string
project_name= "udacity_banana-dqn"
name = "Final run"

#hyperparameters dict in order to log for improving them
hyperparameters = {
    'buffer_size': int(5e5), # replay uffer size
...
class Agent():
    ...
    def __init__(self, state_size, action_size, seed, model=QNetwork):
        ...
        self.optimizer = optim.Adam(self.qnetwork_local.parameters(), lr=hyperparameters["lr"])
        
        # Replay memory
        self.memory = ReplayBuffer(action_size, hyperparameters["buffer_size"], hyperparameters["batch_size"], seed, device)
    ...
    def learn(self, experiences, gamma):
        ...
        self.soft_update(self.qnetwork_local, self.qnetwork_target, hyperparameters["tau"])
